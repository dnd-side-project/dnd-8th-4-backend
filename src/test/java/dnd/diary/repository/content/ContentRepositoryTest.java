...
class ContentRepositoryTest {
    ...
    void findByMapList() {
        ...
        Content content = getContentAndSave(user, group, 37.802508, 127.076286);

        List<Long> groupIds = List.of(group.getId());

        // when
        List<Content> byMapList = contentRepository.findByMapList(groupIds, 37.806840, 37.798631, 127.071024, 127.081482);

        // then
        assertThat(byMapList).hasSize(1)
                .extracting("content")
                .contains("테스트 내용");
    }
